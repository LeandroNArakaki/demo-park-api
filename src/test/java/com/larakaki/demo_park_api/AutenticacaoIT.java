...
public class AutenticacaoIT {
    ...
    @Test
    public void autenticar_ComCredenciaisValidos_RetornarTokenStatus200() {
    ...
    @Test
    public void autenticar_ComCredenciaisInvalidos_RetornarErrorMessageStatus400() {
    ...
    @Test
    public void autenticar_ComUsernameInvalidos_RetornarErrorMessageStatus422() {
        ErrorMessage responseBody = testClient
                .post()
                .uri("/api/v1/auth")
                .contentType(MediaType.APPLICATION_JSON)
    ...
    @Test
    public void autenticar_ComPasswordInvalidos_RetornarErrorMessageStatus422() {
        ErrorMessage responseBody = testClient
                .post()
                .uri("/api/v1/auth")
                .contentType(MediaType.APPLICATION_JSON)
