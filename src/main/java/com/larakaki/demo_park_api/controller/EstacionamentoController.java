...
import com.larakaki.demo_park_api.dto.mapper.ClienteVagaMapper;
...
import com.larakaki.demo_park_api.repository.projection.ClienteVagaProjection;
import com.larakaki.demo_park_api.service.ClienteService;
import com.larakaki.demo_park_api.service.ClienteVagaService;
import com.larakaki.demo_park_api.service.EstacionamentoService;
import com.larakaki.demo_park_api.service.JasperService;
...
public class EstacionamentoController {
    ...
    @Operation(summary = "Operação de check-out", description = "Recurso para dar saída de um veiculo no estacionamento." +
            "Requisição exige uso de um bearer token. Acesso restrito a Role = 'ADMIN'",
            security = @SecurityRequirement(name = "security"),
            parameters = {
                    @Parameter(in = ParameterIn.PATH, name = "recibo", description = "Número do recibo gerado pelo check-in")
    ...
    @Operation(summary = "Localizar os registros de estacionamentos do cliente por CPF",
            ...
            parameters = {
                    ...
                    @Parameter(in = ParameterIn.QUERY, name = "size", content = @Content(schema = @Schema(type = "integer", defaultValue = "5")),
                            description = "Representa o total de elementos por página"
                    ),
                    @Parameter(in = ParameterIn.QUERY, name = "sort", description = "Campo padrão de ordenação pela data de entrada.",
